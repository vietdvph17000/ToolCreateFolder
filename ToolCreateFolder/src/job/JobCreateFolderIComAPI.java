...
public class JobCreateFolderIComAPI {
    ...
    public static void scheduleTask(Timer timer) {
    	JobCreateFolderIComAPI jobGetHsoTCM = new JobCreateFolderIComAPI();
        Integer notifID;
        jobGetHsoTCM.setTimer(timer);
        notifID = timer.addNotification(TCMNotificationGetDataListener.XLY_TAO_TMUC_ICOM, null, jobGetHsoTCM,
    ...
    private static final Logger LOGGER = Logger.getLogger(JobCreateFolderIComAPI.class.getName());
    ...
    public void TCMCenterProcess() {
        ...
        try (Connection conn = new TCM_Connection().getConnection()) {
            ...
            mapJob.put("param_code", "JOB_CREATE_FOLDER_ICOM_API");
